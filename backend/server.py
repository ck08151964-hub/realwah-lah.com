...
# Payment gateway test routes (verify Stripe removal complete)
from routes.payments_test import build_payment_test_router  # noqa: E402
app.include_router(build_payment_test_router(db))
# CORS Configuration
